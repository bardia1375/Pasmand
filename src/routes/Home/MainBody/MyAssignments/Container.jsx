...
export const MyAssignments = () => {
  ...
  useEffect(() => {
    ...
    myApi
      ...
      .then((res) => {
        ...
        myApi
          .get(
            `/v1/MobileApp/GetMyAssignment?filter_groups[0][filters][0][key]=user_id&filter_groups[0][filters][0][value][0]=${info.UserId}&filter_groups[0][filters][0][operator]=in&sort[0][key]=datetime&sort[0][direction]=DESC&limit=10&page=0`,
            {
              headers: {
                Authorization: `Bearer ${Token}`,
              },
  ...
  useEffect(() => {
    if (page > 0) {
      ...
      if (!!date.from) {
        myApi
          .get(
            `/v1/MobileApp/GetMyAssignment?filter_groups[0][filters][1][key]=datetime&filter_groups[0][filters][1][value][0]=${date.from} 00:00:00&filter_groups[0][filters][1][value][1]=${date.to} 23:59:59&filter_groups[0][filters][1][operator]=bt&sort[0][key]=datetime&sort[0][direction]=DESC&limit=10&page=${page}`,
            {
              headers: {
                Authorization: `Bearer ${Token}`,
              },
        ...
        myApi
          .get(
            `/v1/MobileApp/GetMyAssignment?filter_groups[0][filters][0][key]=user_id&filter_groups[0][filters][0][value][0]=${info.UserId}&filter_groups[0][filters][0][operator]=in&sort[0][key]=datetime&sort[0][direction]=DESC&limit=10&page=${page}`,
            {
              headers: {
                Authorization: `Bearer ${Token}`,
              },
  ...
  useEffect(() => {
    ...
    if (!!date.from) {
      myApi
        .get(
          `/v1/MobileApp/GetMyAssignment?filter_groups[0][filters][1][key]=datetime&filter_groups[0][filters][1][value][0]=${date.from} 00:00:00&filter_groups[0][filters][1][value][1]=${date.to} 23:59:59&filter_groups[0][filters][1][operator]=bt&sort[0][key]=datetime&sort[0][direction]=DESC&limit=10&page=0`,
          {
            headers: {
              Authorization: `Bearer ${Token}`,
            },
